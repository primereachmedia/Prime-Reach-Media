  ...
  return (
    <section className="relative overflow-hidden bg-white dark:bg-slate-950 pt-20 pb-24 md:pt-32 md:pb-40 transition-colors">
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10 text-center">
        <span className="inline-block px-4 py-1.5 rounded-full bg-prmgold/10 dark:bg-prmgold/20 text-prmgold-dark dark:text-prmgold font-bold text-sm mb-8 uppercase tracking-widest border border-prmgold/20">
