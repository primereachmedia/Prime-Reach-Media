    ...
    <section className="py-24 bg-slate-50 dark:bg-slate-900 transition-colors">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          {/* For Creators */}
          <div id="creators" className="bg-white dark:bg-slate-950 p-10 rounded-3xl shadow-sm border border-slate-200 dark:border-slate-800 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-prmgold/5 rounded-full -translate-y-16 translate-x-16 blur-2xl"></div>
            <div className="w-16 h-16 bg-prmgold/10 dark:bg-prmgold/20 rounded-2xl flex items-center justify-center mb-8">
              <svg className="w-8 h-8 text-prmgold dark:text-prmgold-light" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <ul className="space-y-4">
              {['Guaranteed payouts', 'Full schedule control', 'Passive income stream'].map((item, idx) => (
                <li key={idx} className="flex items-center gap-3 text-slate-700 dark:text-slate-300 font-medium">
                  <svg className="w-5 h-5 text-prmgold dark:text-prmgold-light" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  {item}
                </li>
